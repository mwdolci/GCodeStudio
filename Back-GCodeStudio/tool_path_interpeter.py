...
class ToolPathInterpreter:
    ...
    def analyze(self, list_datas, resolution_cercle):
        """Cette methode recupere les donnees utiles a la construction des trajectoire"""
...
class VtkFunctions:
    ...
    def create_actors(self, datas_rapid_feedrate, datas_work_feedrate, list_actors, current_tool):
        ...
        # Retour
        list_actors.append(actor_rapid_feedrate)
        list_actors.append(actor_work_feedrate)
        return list_actors
